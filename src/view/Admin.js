  ...
  return (
    <div className="flex">
      <div
        ...
        } z-40 h-screen sticky top-0 left-0 p-4 pt-8 relative duration-100 md:duration-300 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 justify-between`}
      >
        <img
          src={control}
